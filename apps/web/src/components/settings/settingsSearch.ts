...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    scope: "environment-defaults",
    searchTerms: [
      "version control git github gitlab forgejo gitea tea codeberg bitbucket gitcode atomgit azure devops hosting integrations credentials scan server environment",
    ],
  },
  {
