...
import * as GitCodeApi from "../sourceControl/GitCodeApi.ts";
...
import * as GitCodePullRequestProvider from "./GitCodePullRequestProvider.ts";
...
export const make = Effect.map(
  Effect.all([
    ...
    GitCodePullRequestProvider.make,
...
export const layer = Layer.effect(PullRequestProviderRegistry, make).pipe(
  ...
  Layer.provide(GitCodeApi.layer),
